...
public:
    ...
    */
    ...
    const GenericValue& operator[](const GenericValue& name) const {
        return const_cast<GenericValue&>(*this)[name];
    }
    ...
    */
    ...
    int GetInt() const {
        RAPIDJSONXML_ASSERT(flags_ & kIntFlag);
        return data_.n.i.i;
    }
    unsigned GetUint() const {
        RAPIDJSONXML_ASSERT(flags_ & kUintFlag);
        return data_.n.u.u;
    }
    int64_t GetInt64() const {
        RAPIDJSONXML_ASSERT(flags_ & kInt64Flag);
        return data_.n.i64;
    }
    uint64_t GetUint64() const {
        RAPIDJSONXML_ASSERT(flags_ & kUint64Flag);
        return data_.n.u64;
    }
    ...
    double GetDouble() const {
        ...
        RAPIDJSONXML_ASSERT((flags_ & kUint64Flag) != 0);
